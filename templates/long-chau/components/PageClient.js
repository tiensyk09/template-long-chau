...
export default function PageClient({ page }) {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-between" style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      <div className="app-container">
        ...
        <main style={{ padding: '60px 0' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h1 style={{ fontSize: '38px', fontWeight: '800', letterSpacing: '-0.03em', color: 'var(--muted-dark)' }}>
              {page.title}
            </h1>
            {page.description && (
