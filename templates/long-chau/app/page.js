...
export async function generateMetadata() {
  try {
    ...
    const defaultTitle = siteTitle[0]?.value || 'Command Code - AI coding agent with taste';
    const defaultDesc = siteDesc[0]?.value || 'The first AI coding agent that learns your coding taste.';
    const defaultKeywords = siteKeywords[0]?.value || 'ai coding agent, taste-1, neuro-symbolic';
